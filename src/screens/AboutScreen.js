...
import { ASSET, C, STYLE, TEXT } from '../config';
...
class AboutScreen extends Component {
  static navigationOptions({ navigation }) {
    ...
    return {
      drawerLabel: 'About',
      drawerIcon: ({ tintColor }) => <Image source={ASSET.info} style={[STYLE.DRAWER_ICON, { tintColor }]} />,
    ...
    return (
      <View style={[STYLE.SCREEN, styles.container]}>
        ...
        <View style={styles.copyright}>
          <Image onPress={() => Linking.openURL(SOHOBASE.URL)} style={styles.brand} source={ASSET.sohobase} />
